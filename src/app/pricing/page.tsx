							...
							<div className="px-6 pb-4 pt-4 flex flex-col flex-grow">
								<ul className="mx-6 pb-4 space-y-1 flex-grow">
									{pack.features.map((f, i) => (
										<li
											key={f.label}
											className="flex items-center gap-2 text-base font-exo2"
										>
											{f.included ? (
								...
								<Link
									href="/contact"
									className={`w-full py-3 rounded-lg text-lg font-bold text-white uppercase mt-auto block text-center ${getButtonColor(
										pack.color
									)} transition`}
								>
									{pack.cta}
